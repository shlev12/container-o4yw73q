...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-o4yw73q.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-o4yw73q.containers.anotherwebservice.com/
...
```
git clone git@github.com:shlev12/container-o4yw73q.git
cd container-o4yw73q
```
...
```
docker attach container-o4yw73q
```
